...
<head>
    ...
    <title>Correction des notes</title>
    ...
    <div class="container">
            ...
            <div class="col-md-7 col-md-offset-2 table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <legend>Correction des notes</legend>
                ...
                <?php   //affiche le groupe choisit ?> 
                    ...
                    if(isset($_POST['groupe'])){
                        $groupe=$_POST['groupe'];
                        try {     
                        $SQL = "SELECT * FROM etudiants etu INNER JOIN notes ON etu.eid=notes.eid  WHERE note>-1 AND gid=$groupe";
                        $res = $db->query($SQL);
                    ...
                    echo"<tbody>";
                        ...
                        <tr>
                            ...
                            <td><?php echo "<a href='ens_mod_note.php?eid=$row[eid]&gid=$groupe&nom=$row[nom]&prenom=$row[prenom]&noet=$row[noet]'> Modifier</a>" ?></td>
                        </tr>    
                     <?php  
                    }
