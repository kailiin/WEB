...
<head>
    ...
    <title>Liste des notes pour un groupe</title>
    ...
    <div class="container">
            ...
            <div class="col-md-7 col-md-offset-2 table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <legend>Liste des notes pour un groupe </legend>
                ...
                <?php   //affiche le groupe choisit ?> 
                    ...
                    if(isset($_POST['groupe'])){
                        ...
                        while($row=$res2->fetch()) {
                         ?>
                            <?php echo"<b>Liste des notes pour le groupe : </b>";?>
                    ...
                    if(isset($_POST['groupe'])){
                        ...
                        $res = $db->query($SQL);
                        if ($res->rowCount()==0) echo "<h3>Groupe sans note!!</h3>";
                        else{        
                        echo"<thead>";
